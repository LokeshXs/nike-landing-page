    ...
    <footer className='max-container '>
      <div className='flex justify-between items-start gap-20 flex-wrap max-lg:flex-col'>
        <div className='flex flex-col item-start '>
          ...
          <p className='mt-6 text-base leading-7 font-montserrat text-white-400 sm:max-w-sm'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Reiciendis eos a reprehenderit cupiditate eaque. Rem voluptatum velit excepturi iure officia.</p>
